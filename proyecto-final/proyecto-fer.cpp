...
Sobre el programa:
  - Reemplazar array packs a vector para agregar, modificar y eliminar el contenido de las bebidas


Opciones usuario:
  - Buscar información: Pedir al usuario el nombre de la bebida e imprimir solo
  la información de la bebida que se encuentra en el arreglo
  (usar un bucle para encontrar packs.nombre_bebida)

  - Agregar información: Crear un nuevo pedido, mostrando todas las bebidas con su precio.
  Y preguntar al usuario la bebida que desea seleccionar más su cantidad.
  Despues de confirmar la compra, crear un nuevo pedido en una archivo .txt

Adicionales:
  - Crear función de mostrar información de los archivos: Mostrar en pantalla toda la información
  de los pedidos del archivo .txt generado cuando el usuario crea un nuevo pedido


Dudas:
  - Que es log y como se puede aplicar en el proyecto
*/